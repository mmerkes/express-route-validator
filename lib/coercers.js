...
module.exports.after = {
  ...
  // Whenever toJSON is incluced in a route, isJSON should be used as a validator.
  toJSON: function (str) {
    try {
      return JSON.parse(str);
    } catch (e) {
      console.error(e, 'Failed to parse JSON. It is recommended to add isJSON validator to any routes with toJSON.');
      return null;
    }
  }
};