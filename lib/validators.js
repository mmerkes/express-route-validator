...
module.exports = {
  ...
  isAfter: function (str, date) {
    return validator.isAfter(str, date instanceof Date ? date : undefined);
  },
  ...
  isBefore: function (str, date) {
    return validator.isBefore(str, date instanceof Date ? date : undefined);
  },
  // isBoolean(str) - check if a string is a boolean.
  isBoolean: validator.isBoolean,
  // isByteLength(str, min [, max]) - check if the string's length (in bytes) falls in a range.
  isByteLength: function (str, args) {
    return validator.isByteLength(str, args[0], args[1]);
  },
  ...
  isEmail: function (str, options) {
    return validator.isEmail(str, typeof options === 'object' ? option : undefined);
  },
  ...
  isFQDN: function (str, options) {
    return validator.isFQDN(str, typeof options === 'object' ? option : undefined);
  },
  ...
  isFloat: function (str, options) {
    return validator.isFloat(str, typeof options === 'object' ? option : undefined);
  },
  ...
  isInt: function (str, options) {
    return validator.isInt(str, typeof options === 'object' ? option : undefined);
  },
  // isJSON(str) - check if the string is valid JSON (note: uses JSON.parse).
  isJSON: validator.isJSON,
  // isLength(str, min [, max]) - check if the string's length falls in a range.
  // Note: this function takes into account surrogate pairs.
  isLength: function (str, args) {
    return validator.isLength(str, args[0], args[1]);
  },
  ...
  isURL: function (str, options) {
    return validator.isURL(str, typeof options === 'object' ? option : undefined);
  },
  ...
  matches: function (str, args) {
    return validator.matches(str, args[0], args[1]);
  }
};